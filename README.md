...
- The performance of GWANN depends also on the distribution of the data. Transforming the data, e.g. to make their distribution normal, often improves the performance of GWANN substantially.
